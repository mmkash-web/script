...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# BEST AUTOSCRIPT - UNIVERSAL VERSION
...
# // Banner
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  Script : ${GRAY} BEST AUTO SCRIPT BY EMMKASHTECH - UNIVERSAL ${NC}"
...
echo -e "\e[32mInstalling basic dependencies...\e[0m"
update_packages
...
if command -v gem &> /dev/null; then
    ...
    echo -e "${ERROR} Ruby gem not available, skipping lolcat"
fi
...
function first_setup(){
    ...
    if [[ "$OS_ID" == "ubuntu" ]]; then
        ...
        echo "Setup Dependencies For Debian $OS_VERSION"
        update_packages
...
clear
izinsc="https://raw.githubusercontent.com/mmkash-web/script/main/keygen"
# USERNAME
rm -f /usr/bin/user
